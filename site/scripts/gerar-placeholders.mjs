...
const placeholders = [
  { arquivo: 'public/dr-antonio.webp', width: 960, height: 1200, texto: 'Foto do Dr. Antonio' },
  { arquivo: 'public/consultorio.webp', width: 900, height: 1100, texto: 'Foto do consultório' },
