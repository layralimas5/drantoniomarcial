    ...
    <header id="topo" className="relative -mt-[3.75rem] overflow-hidden bg-cream-50 pt-[3.75rem] lg:-mt-[4.5rem] lg:h-[min(50vw,900px)] lg:pt-[4.5rem]">
      ...
      <div className="relative lg:absolute lg:inset-0 lg:mx-auto lg:max-w-[1800px]">
        <img
          ...
          fetchPriority="high"
          decoding="async"
          className="aspect-[16/10] w-full object-cover object-[78%_center] sm:aspect-[2/1] lg:h-full lg:w-full lg:aspect-auto lg:object-center"
        />
        <div
          aria-hidden="true"
      ...
      <div className="container-page relative -mt-8 rounded-t-[2rem] bg-cream-50 pt-8 pb-12 md:py-16 lg:mt-0 lg:rounded-none lg:bg-transparent lg:h-full lg:content-center lg:py-8">
        <m.div
          {...fade}
        ...
        >
          ...
          <p className="mt-5 max-w-xl text-lg leading-relaxed text-ink-800 md:mt-6 md:text-[1.3rem]">
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap md:mt-8 lg:mt-6">
          ...
          <p className="mt-7 border-l-2 border-cream-300 pl-4 text-base text-ink-700 md:mt-8 lg:mt-6">
